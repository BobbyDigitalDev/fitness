...
const weightData = [
  ...
  { date: "2026-09-01", value: 201.8, note: "via Fitbit 'You' tab daily summary, fasted status not specified — screenshot sent 2026-09-02 for the prior day. Up 0.2 lb from Aug 31's 201.6, within normal day-to-day noise." },
...
const calorieData = [
  ...
  { date: "2026-09-04", value: 2612, note: "final — usual eggs-over-hard-and-sausage-patty breakfast with a Chobani blueberry yogurt, a tuna salad + 2 hard boiled eggs lunch, a Sun Chips Garden Salsa snack, 2 pouches of Black Forest Organic Gummy Bears, and an Oh Taisho's yakitori dinner with a Sapporo beer, logged retroactively 2026-09-18 — fills what had been a known dinner gap for this day." },
...
const sleepData = [
  ...
  { date: "2026-09-01", hours: 5.67, score: 89, readiness: 56, note: "5h40m, Good score (89), but Daily Readiness only 56 (Moderate) — Cardio Load 7, 3 of 5 exercise days this week. All 5 health metrics in personal range (BR, SpO2, RHR, HRV, skin temp variation); resting HR 63 bpm, HR range 54-123 bpm for the day. Screenshot only showed duration/score/readiness, no bedtime, wake time, sleep-stage breakdown, or oxygen variation this time." },
  ...
  { date: "2026-09-07", hours: 3.72, score: 83, readiness: 99, note: "Only 3h43m asleep, by far the shortest of the recent stretch — still a Good sleep score (83) and Daily Readiness actually hit 99 (High), the week's best, likely because HRV read 65ms (above personal range, a good-direction outlier) even with the short duration. Only 1 of 5 health metrics in personal range this time — HRV was the flagged one (above range); BR, SpO2, RHR, and skin temp variation were all in range. Screenshot only showed duration/score/readiness, no bedtime, wake time, or sleep-stage breakdown this time." },
...
const stepsData = [
  ...
  { date: "2026-09-01", value: 9789, distance: 4.7, calories: 2901, floors: 18, zoneMin: 9, note: "final EOD numbers via Fitbit app, viewed 2026-09-02 — Cardio Load 7 (no target), 3 of 5 exercise days this week, Daily Readiness 56 (Moderate). Includes a 1.39mi tracked walk at 5:00 PM (38 min, see walksData). 5 of 5 health metrics in personal range (BR, SpO2, RHR, HRV, skin temp variation); resting HR 63 bpm, HR range 54-123 bpm for the day." },
  ...
  { date: "2026-09-07", value: 8265, distance: 3.98, calories: 3303, floors: 13, zoneMin: 46, note: "final EOD numbers via Fitbit app, backfilled from a Sep 7 screenshot — Cardio Load 32 (no target, highest of the week so far), 2 of 5 exercise days this week. No individual tracked walk shown. Only 1 of 5 health metrics in personal range: HRV 65 ms read above personal range (BR, SpO2, RHR, skin temp variation all in range); resting HR 58 bpm, HR range 46-118 bpm for the day. Daily Readiness 99 (High), the week's best despite only 3h43m of sleep the night before. No new weigh-in shown — Weight tile still displayed Sep 6's 204 lb. Holiday weekend — meals not logged, by request." },
...
const walksData = [
  ...
  { date: "2026-09-01", name: "Walk", distance: 1.39, duration: 38, note: "Fitbit, 5:00 PM · 1.39 mi · 38 min." },
  { date: "2026-09-01", name: "Remainder of day's Fitbit distance", distance: 3.31, note: "Fills the gap between the day's 1 tracked walksData entry (1.39mi) and the day's total Fitbit distance (4.7mi from stepsData)." },
  { date: "2026-09-02", name: "Walk", distance: 0.62, duration: 26, note: "Fitbit, 12:08 PM · 0.62 mi · 26 min." },
  { date: "2026-09-02", name: "Walk", distance: 0.83, duration: 32, note: "Fitbit, 1:30 PM · 0.83 mi · 32 min." },
  { date: "2026-09-02", name: "Walk", distance: 1.02, duration: 37, note: "Fitbit, 2:04 PM · 1.02 mi · 37 min." },
  { date: "2026-09-02", name: "Treadmill warm-up walk", distance: 0.52, duration: 9, note: "Fitbit, 6:07 PM · 0.52 mi · 9 min — Fitbit auto-labeled this \"Treadmill run,\" but per Bobby it was a warm-up walk right before the Full-Body B gym session (started 6:18 PM, see gymWorkoutsData). Logged here in walksData rather than runsData to match how Bobby actually did it." },
  { date: "2026-09-02", name: "Treadmill cool-down walk", distance: 0.62, duration: 16, note: "Fitbit, 7:26 PM · 0.62 mi · 16 min — Fitbit auto-labeled this \"Treadmill run\" too, but per Bobby it was a cool-down walk right after the Full-Body B session ended (7:24 PM). Logged here in walksData rather than runsData to match how Bobby actually did it." },
  { date: "2026-09-02", name: "Lifetime Gym (Battery Park) → Gai Chicken & Rice (Fulton St)", distance: 0.71, duration: 17, note: "Fitbit, 7:45 PM · 0.71 mi · 17 min. Timing lines up with the Gai Roasted Chicken Bowl dinner logged at 8:06 PM — same route pattern as the Aug 26/28/31 gym-to-dinner walks." },
  { date: "2026-09-02", name: "Remainder of day's Fitbit distance", distance: 4.12, note: "Fills the gap between the day's 6 tracked walksData entries (0.62 + 0.83 + 1.02 + 0.52 + 0.62 + 0.71 = 4.32mi) and the day's total Fitbit distance (8.44mi from stepsData)." },
  { date: "2026-09-03", name: "Walk", distance: 1.2, duration: 44, note: "Fitbit, 11:32 AM · 1.2 mi · 44 min." },
  { date: "2026-09-03", name: "Remainder of day's Fitbit distance", distance: 3.18, note: "Fills the gap between the day's 1 tracked walksData entry (1.2mi) and the day's total Fitbit distance (4.38mi from stepsData)." },
  ...
  { date: "2026-09-07", name: "Remainder of day's Fitbit distance", distance: 3.98, note: "No individual tracked walk shown for this day — this is the full day's Fitbit distance (3.98mi from stepsData)." },
  { date: "2026-09-08", name: "Walk", distance: 2.21, duration: 51, note: "Fitbit, 2:07 PM · 2.21 mi · 51 min." },
  { date: "2026-09-08", name: "Remainder of day's Fitbit distance", distance: 4.29, note: "Fills the gap between the day's 1 tracked walksData entry (2.21mi) and the day's total Fitbit distance (6.5mi from stepsData)." },
  { date: "2026-09-09", name: "Walk", distance: 0.71, duration: 31, note: "Fitbit, 6:42 PM · 0.71 mi · 31 min." },
  { date: "2026-09-09", name: "Remainder of day's Fitbit distance", distance: 4.64, note: "Fills the gap between the day's 1 tracked walksData entry (0.71mi) and the day's total Fitbit distance (5.35mi from stepsData)." },
  { date: "2026-09-10", name: "Walk", distance: 0.87, duration: 33, note: "Fitbit, 7:24 PM · 0.87 mi · 33 min." },
  ...
  { date: "2026-09-17", name: "Walk", distance: 0.61, duration: 32, note: "Fitbit, 8:00 PM · 0.61 mi · 32 min — backfilled from a Sep 20 screenshot viewing the Sep 17 date page directly." },
  { date: "2026-09-17", name: "Remainder of day's Fitbit distance", distance: 3.88, note: "Fills the gap between the day's 1 tracked walksData entry (0.61mi) and the day's total Fitbit distance (4.49mi from stepsData)." },
...
const gymWorkoutsData = [
    ...
    exercises: [
      ...
      },
      {
        ...
        sets: [
          ...
          { reps: 12, weight: 115, feel: "Hard" }
        ]
      },
      {
        name: "Romanian Deadlift",
        note: "These starting numbers are incorrect. The bars were occupied so I substituted with 2 40lbs weights per hand.",
        sets: [
          { reps: 12, weight: 80, feel: "Just right" },
          { reps: 12, weight: 80, feel: "Just right" },
          { reps: 12, weight: 80, feel: null }
        ]
      },
      {
        name: "Rear Delt Fly",
  ...
  },
  {
    ...
    startTime: "11:40",
    endTime: "12:50",
    duration: 70,           // minutes — from the app's own startedAt/endedAt via JSONBin
    exercises: [
      {
        name: "Seated Shoulder Press",
        note: "",
      ...
      {
        name: "Seated Cable Row",
        note: "Did this one first due to availability",
        sets: [
          { reps: 15, weight: 100, feel: "Just right" },
          { reps: 15, weight: 110, feel: "Just right" },
          { reps: 12, weight: 120, feel: "Just right" }
        ]
      },
      {
        name: "Romanian Deadlift",
        note: "The bar was 15kg instead of the usual 20kg, which accounts for the odd numbers.",
        sets: [
          { reps: 12, weight: 83, feel: "Easy" },
          { reps: 12, weight: 103, feel: "Just right" },
          { reps: 12, weight: 103, feel: "Just right" }
        ]
      },
      {
        name: "Rear Delt Fly",
        note: "Did a modified version again — chest supported on an incline bench, pulling up from there, instead of the seated version. Bobby prefers this variant and asked to make it the standard going forward (raised the same swap on Sept 10 too).",
        sets: [
          { reps: 15, weight: 20, feel: "Just right" },
          { reps: 15, weight: 20, feel: "Just right" },
          { reps: 15, weight: 20, feel: "Just right" }
...
const meals = [
  ...
  { date: "2026-09-01", time: "15:33", name: "That's It Organic Fruit Crunchables, Apple + Cinnamon Crisps", photo: "food-photos/2026-09-01-thats-it-apple-cinnamon-crisps.jpeg",
    description: "2 pouches (10g each), label exact — same product as prior snacks (Aug 5/7). Panel clearly photographed this time: 40 cal/9g carb/2g fiber/7g sugar/0g added sugar/0g protein/0mg sodium per pouch.",
  ...
  { date: "2026-09-02", time: "14:35", name: "Eggs Over-Hard (No Salt) & Sausage Patty", photo: "food-photos/2026-09-02-eggs-over-hard-sausage-patty.jpeg",
    description: "2 large eggs, over-hard, no salt + 1 pork sausage patty (~2oz). Same recurring combo as every morning, macros reused directly from the established baseline. No time was stated this turn — 2:35 PM is estimated from when this was sent, notably later than this meal's usual ~9:30 AM.",
    calories: 350, protein: 21, carbs: 2, fat: 29, sodium: 550, sodiumNote: "Sausage patty is doing nearly all the sodium here, not the eggs (no salt added to those)." },
  { date: "2026-09-02", time: "14:35", name: "SunChips Garden Salsa", photo: "food-photos/2026-09-02-sunchips-garden-salsa-1.jpeg",
    description: "SunChips Garden Salsa Flavored, 1 package (1oz/28g) — label exact, same product as the Sept 1 package.",
    calories: 140, protein: 2, carbs: 18, fat: 6, sodium: 140 },
  { date: "2026-09-02", time: "12:31", name: "Los Tacos No. 1 — 2 Adobada + 1 Carne Asada (street tacos)", photo: "food-photos/2026-09-02-lunch-los-tacos-plate.jpeg",
    description: "3 street tacos from Los Tacos No. 1 (NYC taqueria chain): 2 adobada (marinated pork, topped with pineapple) + 1 carne asada (grilled steak) 'with everything.' Per the restaurant's own menu (lostacos1.com/menus), all tacos come standard on corn or flour tortillas with onion, cilantro, salsa and guacamole — matches what's visible in the photos (guac, cilantro, onion, hot salsa drizzle; pineapple strips on the adobada only). No nutrition information is published by Los Tacos No. 1 anywhere (checked their site — menu lists only names/prices), so this is fully estimated from typical small-format street-taco portions (roughly 2.5oz meat + doubled corn tortillas per taco) and the visible garnish amounts.",
    calories: 1170, protein: 58, carbs: 107, fat: 55, sodium: 1960, sodiumNote: "No published nutrition data — estimated. Marinated/grilled meats, salsa, and guac across 3 tacos add up; treat this sodium figure as a rough floor given the BP meds, not a precise number." },
  { date: "2026-09-02", time: "14:32", name: "Afternoon Snack — Gummy Bears, Fruit Crunchables & Chobani Yogurt", photo: "food-photos/2026-09-02-snack-gummybears-crunchables-yogurt.jpeg",
    description: "2 pouches Black Forest Organic Gummy Bears (label exact: 40 cal/9g carb/0g fiber/7g sugar/0g fat/~0g protein/0mg sodium per 10g pouch) + 2 pouches That's It Organic Fruit Crunchables Apple + Cinnamon Crisps (same product as the Sept 1 snack — 40 cal/9g carb/0g fat/0g protein/0mg sodium per 10g pouch) + 1 Chobani Greek Yogurt Strawberry (label exact, same product as prior entries — 110/11/15/0/55).",
    calories: 270, protein: 11, carbs: 51, fat: 0, sodium: 55 },
  { date: "2026-09-02", time: "20:06", name: "Gai Roasted Chicken Bowl", photo: "food-photos/2026-09-02-dinner-gai-chicken-rice.jpeg",
    description: "After-gym dinner at Gai Chicken & Rice — heavily charred roasted chicken thigh over white rice with a side salad (lettuce, corn, cherry tomatoes, cucumber). Same specific menu item as the Aug 8/28/31 entries ('Gai Roasted Chicken Bowl'), so macros are reused directly from that established baseline rather than re-estimated from scratch. Note: no Sept 2 gym session has been logged in gymWorkoutsData yet, even though Bobby referenced 'after the gym' — worth backfilling if a session happened.",
    calories: 820, protein: 60, carbs: 78, fat: 29, sodium: 950, sodiumNote: "Restaurant-cooked, no label — reused from the Aug 8 estimate for the same menu item." },
  { date: "2026-09-03", time: "09:47", name: "Peanut Butter & Jelly Sandwich (Made Here) & Chobani Strawberry Yogurt", photo: "food-photos/2026-09-03-breakfast-pbj-sandwich-open.jpeg",
    description: "Got to work late and the office cafe kitchen was closed, so picked up a grab-and-go PB&J sandwich (Made Here brand, 2 slices wheat bread, peanut butter, jelly, $4.50 — no nutrition panel on the label, just price/barcode) + a Chobani Greek Yogurt Strawberry (label exact, same product as prior entries — 110/11/15/0/55). Sandwich macros estimated from typical PB&J proportions: ~2 tbsp peanut butter, ~1 tbsp jelly, 2 slices sandwich bread.",
    calories: 490, protein: 24, carbs: 58, fat: 18, sodium: 490, sodiumNote: "Estimated — no nutrition label on the sandwich; sodium mostly from the bread, peanut butter's contribution is smaller." },
  { date: "2026-09-03", time: "12:04", name: "Tuna Salad & 2 Hard Boiled Eggs", photo: "food-photos/2026-09-03-lunch-tuna-salad-eggs.jpeg",
    description: "0.34 lb tuna salad (with celery/green onion) + 2 whole hard boiled eggs. Same recurring lunch combo — macros built from the established per-lb tuna-salad rate (840.5 cal/76.8g protein/13.2g carb/57.8g fat/1800mg sodium per lb, isolated from the standard 2-egg baseline) plus the standard 2-egg baseline (156/12.6/1.1/10.6/124).",
  ...
  { date: "2026-09-04", time: "11:43", name: "Tuna Salad & 2 Hard Boiled Eggs", photo: "food-photos/2026-09-04-lunch-tuna-salad-eggs.jpeg",
    ...
    calories: 442, protein: 39, carbs: 6, fat: 30, sodium: 736 },
  { date: "2026-09-04", time: "12:02", name: "Sun Chips Garden Salsa", photo: "food-photos/2026-09-04-snack-sunchips-front.jpeg",
    description: "1 oz package (1 serving per container), label exact — same product/rate as prior Sun Chips Garden Salsa entries, macros reused directly.",
    calories: 140, protein: 2, carbs: 18, fat: 6, sodium: 140 },
  { date: "2026-09-04", time: "12:14", name: "Black Forest Organic Gummy Bears", photo: "food-photos/2026-09-04-lunch-gummybears.jpeg",
    ...
    calories: 80, protein: 0, carbs: 18, fat: 0, sodium: 0 },
  { date: "2026-09-04", time: "20:00", name: "Oh Taisho's (St. Mark's Place): Yakitori & Sapporo Beer", photo: "food-photos/2026-09-04-dinner-ohtaisho-skewers.jpeg",
    description: "Izakaya dinner at Oh Taisho's (yakitoritaishony.com), logged retroactively 2026-09-18 — a 12oz Sapporo Premium Beer, a grilled soy-glazed rice ball (yaki onigiri) with pickled radish, 3 pork belly (buta bara) skewers, 2 tsukune (chicken meatball) skewers, 1 bacon-wrapped asparagus (asparabacon) skewer, 1 Berkshire pork sausage skewer, and a cabbage side with dipping sauce. No menu/nutrition data from the restaurant, so every component is a visual estimate from typical yakitori-skewer and izakaya-side reference values — wider uncertainty than usual, especially for the tare-glazed items where sauce quantity varies a lot by skewer.",
    calories: 1490, protein: 65, carbs: 91, fat: 80, sodium: 2460, sodiumNote: "Estimated, but flagged as high — tare glaze (soy-based) on the rice ball, tsukune, and pork belly, plus the sausage and cabbage dipping sauce, stack up fast at an izakaya. This single dinner is roughly a full day's sodium guideline on its own; worth keeping in mind given the Lisinopril/Nifedipine, same flag as the recent BBQ lunch." },
  ...
  { date: "2026-09-08", time: "20:26", name: "Panko-Crusted Fluke (Self-Caught) & Spring Mix Salad", photo: "food-photos/2026-09-08-dinner-panko-fluke-salad.jpeg",
    description: "Fluke fillet(s) from a fishing trip, panko-breaded and baked — no label/receipt, raw weight confirmed by Bobby at ~6-8oz (used 7oz/198g midpoint): USDA flatfish raw reference (91 cal/18.8g protein/1.2g fat per 100g) plus an estimated panko/egg-wash/light-oil breading (~180 cal/7g protein/22g carb/8g fat). Side salad: spring mix/spinach with avocado, dried cranberries, and a mixed nut medley (almonds, walnuts, pistachios, pecans — looks like TJ's trail mix tossed in) with a light vinaigrette — all portions sized by eye from the photo, no label. Rough visual estimate overall, not label-exact.",
    calories: 667, protein: 50, carbs: 43, fat: 33, sodium: 700, sodiumNote: "Estimated throughout — breading salt, trail mix salt, and vinaigrette are the main assumed sodium sources; no label to check against." },
  ...
  { date: "2026-09-09", time: "16:30", name: "Whole Foods 365 Organic Reduced Fat & Sodium Popcorn", photo: "food-photos/2026-09-08-snack-popcorn-cup.jpeg",
    ...
    calories: 115, protein: 2, carbs: 15, fat: 5, sodium: 70 },
  { date: "2026-09-09", time: "20:03", name: "Trader Joe's Trail Mix", photo: "food-photos/2026-09-09-snack-trailmix-bowl.jpeg",
    description: "2 tbsp (~20g) of a nut-heavy Trader Joe's trail mix (almonds, walnuts, pistachios, pumpkin seeds, dried cranberries/cherries) — no label photo, estimated from a generic nuts+seeds+dried-fruit trail mix reference (~460 cal/100g) scaled to the small portion shown.",
    calories: 90, protein: 2, carbs: 9, fat: 6, sodium: 30, sodiumNote: "Estimated — unclear if the nuts are salted; assumed lightly salted." },
  { date: "2026-09-09", time: "20:21", name: "Rice Protein, Peanut Butter & Almond Milk Shake (No Banana)", photo: "food-photos/2026-09-09-shake-pb-almond-milk-rice-protein.jpeg",
    description: "3 scoops rice protein + 3 tbsp chunky peanut butter + ice + almond milk, no banana — same recipe as the Aug 8 4:45 PM shake (3 tbsp PB, no banana), macros reused directly.",
    calories: 740, protein: 62, carbs: 21, fat: 32, sodium: 365 },
  ...
  { date: "2026-09-15", time: "19:45", name: "Half Whole Foods Classic Rotisserie Chicken", photo: "food-photos/2026-09-15-dinner-wholefoods-chicken.jpeg",
    description: "Half a Whole Foods Market Classic Rotisserie Chicken (chicken, organic salt & pepper blend only, packed 09.15.26), net wt 1lb 12oz (794g) whole bird including bone — identical product/weight to the Aug 4 entry, macros reused directly from that established calculation (label: 200 cal/18g protein/14g fat/0g carb/360mg sodium per 3oz edible serving; half the bird's edible meat+skin estimated at ~278g/~3.3 servings, assuming ~70% edible yield). Bobby photographed what was left on the plate, not the portion eaten, so the eaten half is inferred from his stated \"half the chicken,\" not visually confirmed.",
    calories: 650, protein: 58, carbs: 0, fat: 46, sodium: 1160, sodiumNote: "Confirmed via label — Whole Foods rotisserie chicken runs 360mg sodium per 3oz, well above home-roasted (brined/seasoned before cooking). Single biggest sodium contributor of the day." },
  { date: "2026-09-16", time: "09:30", name: "Eggs Over-Hard (No Salt), Sausage Patty, Chobani Strawberry Yogurt & Sun Chips", photo: "food-photos/2026-09-16-breakfast-eggs-sausage.jpeg",
    description: "Usual breakfast: 2 large eggs, over-hard, no salt + 1 breakfast sausage patty, macros reused directly from the established baseline. Plus a Chobani Non-Fat Greek Yogurt, Strawberry on the Bottom (150g container, label-exact: 110 cal/11g protein/15g carb/0g fat/55mg sodium) and a Sun Chips Garden Salsa 1oz bag (label-exact: 140 cal/2g protein/18g carb/6g fat/140mg sodium). Logged retroactively 2026-09-18.",
  ...
  { date: "2026-09-16", time: "12:30", name: "Company BBQ: Brisket, Pulled Pork, Green Beans & Cornbread", photo: "food-photos/2026-09-16-lunch-bbq-brisket-pulledpork.jpeg",
    description: "Catered company BBQ, no menu/nutrition info available — fully a visual portion estimate, wider uncertainty than usual. ~3oz smoked brisket (bark visible, some fat), ~4.5oz sauced pulled pork, ~1 cup Southern-style green beans cooked with diced onion (likely with bacon/ham fat and added salt, typical of this style), and 2 pieces cornbread (~2.5oz total). No receipt, no label — estimated from typical values for each component at a catered BBQ.",
    calories: 900, protein: 52, carbs: 57, fat: 48, sodium: 2000, sodiumNote: "Estimated, but flagged as notably high — Southern-style green beans, BBQ sauce on the pulled pork, and a dry-rub bark on the brisket are all salt-heavy prep styles, and this is a single-meal total near the daily 2,300mg sodium guideline on its own. Worth keeping in mind given the Lisinopril/Nifedipine." },
  { date: "2026-09-16", time: "19:30", name: "Whole Foods Rotisserie Chicken (Leg & Thigh) & Side Salad", photo: "food-photos/2026-09-16-dinner-wholefoods-chicken-salad.jpeg",
    description: "A Whole Foods Classic Rotisserie Chicken leg quarter (thigh + drumstick, salt & pepper only, skin-on) — same product as the Aug 4 entry, scaled from that label (200 cal/18g protein/14g fat/0g carb/360mg sodium per 3oz edible serving) assuming ~5.5oz edible meat+skin for a leg quarter. Plus a homemade-looking side salad — baby spinach/mixed greens, cherry tomatoes, almonds, pumpkin seeds, walnuts, sesame seeds, and what looks like dried cranberries or roasted beets, dressed in a glossy vinaigrette. No label for the salad (nut/seed content estimated as generous based on the photo), so this half of the meal carries more uncertainty than the chicken.",
    calories: 705, protein: 39, carbs: 20, fat: 51, sodium: 820, sodiumNote: "Chicken (label-based estimate) and the vinaigrette are the two main sodium sources; the nuts/seeds/greens themselves are low-sodium." },
  { date: "2026-09-17", time: "09:30", name: "Eggs Over-Hard (No Salt), Sausage Patty, Chobani Strawberry Yogurt & Sun Chips", photo: "food-photos/2026-09-17-breakfast-eggs-sausage.jpeg",
    description: "Usual breakfast: 2 large eggs, over-hard, no salt + 1 breakfast sausage patty, macros reused directly from the established baseline. Plus a Chobani Non-Fat Greek Yogurt, Strawberry on the Bottom (150g container, label-exact: 110 cal/11g protein/15g carb/0g fat/55mg sodium) and a Sun Chips Garden Salsa 1oz bag (label-exact: 140 cal/2g protein/18g carb/6g fat/140mg sodium). Logged retroactively 2026-09-18 (\"yesterday's breakfast\").",
    calories: 600, protein: 34, carbs: 35, fat: 35, sodium: 745, sodiumNote: "Sausage patty (550mg) is the main sodium source; yogurt (55mg) and Sun Chips (140mg) both label-exact and minor by comparison." },
  { date: "2026-09-17", time: "13:00", name: "Shrimp, 2 Hard Boiled Eggs, Chobani Raspberry Yogurt & Lemon Raspberry Cheesecake", photo: "food-photos/2026-09-17-lunch-shrimp-eggs.jpeg",
    description: "0.36 lb shrimp (plain/lightly seasoned, no visible sauce or butter) — same weight as the Sept 8 lunch, so macros scaled from the established herb-seasoned-shrimp rate (180 cal/36g protein/2g carb/3g fat/350mg sodium per 0.33 lb) the same way. Plus 2 whole hard boiled eggs (standard reused baseline: 156/12.6/1.1/10.6/124, no romaine pack this time) and a Chobani Non-Fat Greek Yogurt Raspberry (150g, label-exact: 110 cal/12g protein/15g carb/0g fat/80mg sodium — note this flavor's label differs slightly from the strawberry variant used on other days, 80mg sodium vs. 55mg). Dessert: a Made Here Lemon Raspberry Cheesecake (shortbread base, raspberry jam layer, cheesecake, white chocolate curls) — the catering label photographed shows all zeros (Cal 0, Net Weight: 0), clearly a broken/placeholder label rather than real data, so this is a from-scratch visual estimate for a rich individual bakery cheesecake (~420 cal/30g fat/34g carb/5g protein/220mg sodium for a full ~4oz portion), of which Bobby ate about 60% (~252 cal/18g fat/20g carb/3g protein/132mg sodium) — wider-than-usual uncertainty given there's no usable label or restaurant data at all for this item.",
    calories: 714, protein: 67, carbs: 38, fat: 32, sodium: 718, sodiumNote: "Shrimp is the single biggest contributor (scaled estimate, no label); the cheesecake's sodium is also a rough estimate. Eggs and yogurt are exact/reused baselines." },
...
const proteinData = [
  ...
  { date: "2026-09-04", value: 139, note: "final — usual eggs-over-hard-and-sausage-patty breakfast with a Chobani blueberry yogurt, a tuna salad + 2 hard boiled eggs lunch, a Sun Chips Garden Salsa snack, 2 pouches of Black Forest Organic Gummy Bears, and an Oh Taisho's yakitori dinner with a Sapporo beer, logged retroactively 2026-09-18 — fills what had been a known dinner gap for this day." },
